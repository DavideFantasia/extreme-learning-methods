% test_comparison.m
% Confronto completo CG vs LSQR vs QR su ELM
%   - Figura 1: Iterazioni CG vs hidden dimension  (come Fig 4.4 del report)
%   - Figura 2: Iterazioni LSQR vs hidden dimension
...
% Preallocazione
avg_times_cg    = zeros(nH, 1);  avg_iters_cg    = zeros(nH, 1);  avg_err_cg   = zeros(nH, 1);
avg_times_lsqr  = zeros(nH, 1);  avg_iters_lsqr  = zeros(nH, 1);  avg_err_lsqr = zeros(nH, 1);
avg_times_qr    = zeros(nH, 1);  avg_err_qr      = zeros(nH, 1);
...
% =========================================================
% Figura 1 -- Iterazioni CG vs hidden_dim  (speculare a Fig 4.4)
% =========================================================
figure;
...
% =========================================================
% Figura 2 -- Iterazioni LSQR vs hidden_dim  (nuova, analoga a Fig 4.4)
% =========================================================
figure;
